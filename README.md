...
**WhatsApp Chat Browser** is a tool to render your archived WhatsApp
and Telegram chats. **WhatsApp Chat Browser** reads your archived chats,
turns them into HTML, and serves them to your browser for viewing or
printing.
...
**WhatsApp Chat Browser** reads chat archives:

- from ZIP files exported by WhatsApp,
- from JSON files exported using WhatsApp Chat Exporter, or
- from JSON files exported by Telegram.
...
Exporting chats from Telegram is done using the
[Telegram Desktop](https://desktop.telegram.org/) application on your
PC and linking it to your phone. See also
[here](https://telegram.org/blog/export-and-more).

Notes:

- Only **export individual chats** by opening the `...` in any chat and
  choosing **Export chat history**.
- In the **Location and format** section, choose
  **Machine-readable JSON**.

Telegram exports the chat to a directory. That directory contains the
file `result.json`, which you can then load into **WhatsApp Chat Browser**.
You may also ZIP the folder and use the ZIP file instead.
